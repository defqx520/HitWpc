package cn.edu.hit.ftcl.wearablepc.VoiceControl;
...
import cn.edu.hit.ftcl.wearablepc.VoiceControl.speechUtils.*;


import cn.edu.hit.ftcl.wearablepc.R;
import cn.edu.hit.ftcl.wearablepc.VoiceModule.VoiceActivity;
...
//                    text = JsonParser.parseGrammarResult(result.getResultString(), mEngineType);
                    id = JsonParser.myparseGrammarResult(result.getResultString());
                ...
                switch (id){
                    case 101:
                        ...
                        Intent intent0 = new Intent(VoiceControlActivity.this, MapActivity.class);
                        startActivity(intent0);
                        break;
                    case 102:
                        Toast.makeText(getApplicationContext(),"102",Toast.LENGTH_SHORT).show();
                        Intent intent1 = new Intent(VoiceControlActivity.this, SensorActivity.class);
                    ...
                    case 104:
                        ...
                        Intent intent3 = new Intent(VoiceControlActivity.this, FtpFileListActivity.class);
                        startActivity(intent3);
                        break;
                }
                // 显示
                ((EditText) findViewById(R.id.isr_text)).setText(result.getResultString());
            } else {
