...
import cn.edu.hit.ftcl.wearablepc.VoiceModule.Parameter;
import cn.edu.hit.ftcl.wearablepc.VoiceModule.SettingsActivity;
...
public class IndexActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Parameter pTargetIP = new Parameter("target_ip", "192.168.0.21");
        pTargetIP.save();
